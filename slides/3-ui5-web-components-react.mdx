...
<iframe style={{width: 'var(--base-max-width)'}} height={800} src="https://sap.github.io/ui5-webcomponents-react/master/iframe.html?id=layouts-floorplans-objectpage--default-story&viewMode=story" />

---

# Complex Layouts and Charts

<iframe style={{width: 'var(--base-max-width)'}} height={800} src="https://sap.github.io/ui5-webcomponents-react/master/iframe.html?id=charts-barchart--default-story&viewMode=story" />
